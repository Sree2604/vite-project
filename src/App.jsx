          ...
          <div className="shop-new">
            <div className="blog">
              ...
              <div className="frame-7">
                ...
                <div className="shop-now-2">Shop now &gt;&gt;</div>
              </div>
            </div>
            <div className="div-2">
              <div className="group-2">
                <div className="group-3">
                  ...
                  />
                  <div className="text-wrapper-10">Shop New</div>
                </div>
              ...
              <div className="overlap-3">
                ...
                <div className="frame-15">
                  <div className="image-2">
                    <div className="overlap-group-2">
                      <div className="text-wrapper-20">Season Discount</div>
                      <div className="text-wrapper-21">$29.99</div>
                      <div className="text-wrapper-22">Delivery of Dry Goods</div>
                    </div>
                  </div>
                  <div className="product-cards">
                    <div className="div-3">
